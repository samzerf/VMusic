...
const Upload2CDN = require('./upload-to-cdn')
const fileName = 'm-' + (Date.now()).toString(16)
...
module.exports = {
  ...
  chainWebpack(config) {
    config.plugin('Upload2CDN').use(Upload2CDN, [{filename: fileName}])
  ...
  publicPath: `https://samzherf-1256415834.file.myqcloud.com/static/${fileName}/`
}
